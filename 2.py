...
# print(sum(even_nos), sum(odd_nos))
...
# "inventory": 100
# }
# x=((dict["sell_price"]-dict["cost_price"]) * dict["inventory"])
# print(int(x))
...
# x=is_harshad=(171)
# y=is_harshad=str(is_harshad)
# z=is_harshad=list(is_harshad)
# a=is_harshad=map(int,list(is_harshad))
# b=list(is_harshad)
# sum=sum(b)
# z=x%sum==0
# print(z)
...
# x="55l545"
# y=(len(x)==4)+(len(x)==6) and x.isdigit()
# print (y)

'''11Write a Python program to return a new set with unique items from both sets by removing duplicates.
Given:
set1 = {10, 20, 30, 40, 50}
set2 = {30, 40, 50, 60, 70}
Expected output:
